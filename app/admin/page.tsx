...
export default function AdminPage() {
  ...
  if(loading) return <div className="min-h-screen flex items-center justify-center text-5xl">âï¸</div>

  return (
    <div className="flex min-h-screen">
      <aside className="w-56 bg-slate-900 min-h-screen fixed left-0 top-0 p-6">
        <div className="font-black text-white text-lg mb-6">ð VanGo Admin</div>
        <Link href="/" className="text-slate-400 text-sm">â Back to site</Link>
      </aside>
